...
if (isset($_POST['edit'])) {
mysqli_query($connection,"UPDATE employee set first_name='" . $_POST['first_name'] . "', last_name='" . $_POST['last_name'] . "', email='" . $_POST['email'] . "', telephone='" . $_POST['telephone'] . "', image_url='" . $_POST['image_url'] . "', job='" . $_POST['job'] . "', Description='" . $_POST['content'] . "' WHERE id='" . $_POST['id'] . "'");
...
function storeImgId(id){
   ...
   alert("Image Selected !");
    ...
    //find special characters and add backslash
    var re = /([^a-zA-Z0-9])/g; 
